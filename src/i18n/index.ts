...
const en: Dict = {
  ...
  'clinics.nothingHere': 'Nothing chosen here yet. Tap Edit services.',
...
const ar: Dict = {
  ...
  'clinics.nothingHere': 'لم تختاري شيئًا هنا بعد. المسي تعديل الخدمات.',
...
const fr: Dict = {
  ...
  'clinics.nothingHere': 'Rien de choisi ici. Touchez Modifier les services.',
