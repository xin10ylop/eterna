...
const en: Dict = {
  ...
  'event.past': 'Past',
  'event.passed': 'Passed',
  'event.toBook': 'To schedule',
  'event.booked': 'Booked',
  'event.ready': '{done} of {total} ready',
  'event.want': 'What would you like ready?',
  'event.bookedOn': 'Booked · {date}',
  'event.bookBy': 'Book by {date}',
  'event.setFresh': "You're set — still fresh",
  'event.alsoFor': 'Also for {names}',
  'event.editPicks': 'Edit rituals',
  'event.choose': 'Choose rituals',
  'event.also': 'also {names}',
  'event.otherCalendar': 'Also on your calendar',
  'event.addons': 'Add-ons',
  'event.addonCta': 'Add something for your events',
  'event.asap': 'Book soon',
  'event.allSet': 'Everything for your events is booked.',
...
const fr: Dict = {
  ...
  'event.past': 'Passés',
  'event.passed': 'Passé',
  'event.toBook': 'À planifier',
  'event.booked': 'Réservé',
  'event.ready': '{done} sur {total} prêt',
  'event.want': 'Que souhaitez-vous prêt ?',
  'event.bookedOn': 'Réservé · {date}',
  'event.bookBy': 'À réserver avant {date}',
  'event.setFresh': "C'est bon — encore frais",
  'event.alsoFor': 'Aussi pour {names}',
  'event.editPicks': 'Modifier les soins',
  'event.choose': 'Choisir les soins',
  'event.also': 'aussi {names}',
  'event.otherCalendar': 'Aussi dans votre agenda',
  'event.addons': 'Extras',
  'event.addonCta': 'Ajoutez un soin pour vos événements',
  'event.asap': 'Réservez bientôt',
  'event.allSet': 'Tout est réservé pour vos événements.',
